...
public class ContaService {
	...
	public Page<Transacao> getExtratoPage(int idConta, Pageable pageable){
		Conta conta = repository.findById(idConta).orElse(null);
		return transRepository.findAllByConta(conta, pageable);
	}

	public List<Conta> getContasAtivas() {
		
		ArrayList<Conta> contasAtivas = new ArrayList<Conta>();
